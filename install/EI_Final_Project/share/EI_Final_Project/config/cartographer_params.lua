-- 基于Cartographer官方示例的2D SLAM配置
-- 专为RPLidar和TurtleBot3优化
...
POSE_GRAPH.constraint_builder.ceres_solver_options.use_nonmonotonic_steps = false
POSE_GRAPH.constraint_builder.ceres_solver_options.max_num_iterations = 50
POSE_GRAPH.constraint_builder.ceres_solver_options.num_threads = 7
